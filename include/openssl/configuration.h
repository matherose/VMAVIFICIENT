/*
 * WARNING: do not edit!
 * Generated by configdata.pm from third_party/openssl/Configurations/common0.tmpl,
 * third_party/openssl/Configurations/unix-Makefile.tmpl via Makefile.in
 *
...
/* clang-format on */
    ...
    (defined(OPENSSL_NO_BROTLI) && defined(OPENSSL_NO_ZSTD) && defined(OPENSSL_NO_ZLIB))
